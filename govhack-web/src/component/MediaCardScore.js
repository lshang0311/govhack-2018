    ...
    <Card className={classes.card}>
      <CardActionArea>
        <div style={{position: 'relative'}}>
          <div className={'risk-level__background risk-level__background' + (props.score < 34 ? '--low' : props.score < 67 ? '--moderate' : '--high')}>
            <Typography
              gutterBottom
              variant="headline"
              component="h2"
              ...
              {props.score < 34 ? <FontAwesomeIcon icon="info-circle" /> : <FontAwesomeIcon icon="exclamation-triangle" />}&nbsp;
